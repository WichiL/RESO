...
<head>
    ...
    <title><?php echo $__env->yieldContent('meta-title', config('app.name') . " | Inicio"); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta-description', 'Convocatorias de SEZAC'); ?>">
